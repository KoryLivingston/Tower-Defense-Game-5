Public Class Enemy
    ...
    Public Sub MoveEnemy()
        ...
        If Enemygraphic.Location.X > -1000 And Enemygraphic.Location.X < 420 Then
            Enemygraphic.Left += MovementSpeed
        End If

        If Enemygraphic.Location.X > 419 And Enemygraphic.Location.Y > 94 Then
            Enemygraphic.Top -= MovementSpeed
        End If

        If Enemygraphic.Location.Y <= 93 Then
            Enemygraphic.Left += MovementSpeed
        End If
    ...
    Public Sub EnemyReachedBase()
        ...
        If Enemygraphic.Bounds.IntersectsWith(Form1.Base.Bounds) Then
